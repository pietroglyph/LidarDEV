...
public class MotionProfileGoal
{
     ...
     * magnitude. But what should we do if we would
     ...
     * (for example, there is an obstacle in front of us - slam the brakes
     * harder than we'd like in order to avoid
     * hitting it).
     * 
     * VIOLATE_MAX_ABS_VEL - If the max velocity is just a general guideline and
     * not a hard performance limit, it's
