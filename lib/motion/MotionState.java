...
public class MotionState
{
     ...
     * @return A MotionState that is a valid predecessor (if t<=0) or successor
     *         (if t>=0) of this state.
     */
    ...
    /**
     * Find the next time (first time > MotionState.t()) that this MotionState
     * will be at pos. This is an inverse of the
     * extrapolate() method.
     * 
     * @param pos
    ...
    /**
     * Checks if two MotionStates are epsilon-equals (all fields are equal
     * within a nominal tolerance).
     */
    @Override
    ...
    /**
     * Checks if two MotionStates are coincident (t, pos, and vel are equal
     * within a nominal tolerance, but acceleration
     * may be different).
     */
    ...
    /**
     * Checks if two MotionStates are coincident (t, pos, and vel are equal
     * within a specified tolerance, but
    ...
    /**
     * Returns a MotionState that is the mirror image of this one. Pos, vel, and
     * acc are all negated, but time is not.
     */
