...
public class SetpointGenerator
{
     ...
     * whether this is setpoint achieves the goal
     * (useful for higher-level logic to know that it is now time to do
     * something else).
     */
    ...
    /**
     * Get the full profile from the latest call to getSetpoint(). Useful to
     * check estimated time or distance to goal.
     * 
     * @return The profile from the latest call to getSetpoint(), or null if
     *         there is not yet a profile.
     */
